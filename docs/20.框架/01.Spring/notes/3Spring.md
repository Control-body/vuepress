---
title: Spring(3)-AOP xml配置 注解配置 AOP原理
tags: 
- AOP
- xml
- AOP原理
---
AOP xml配置 注解配置 AOP原理
# AOP

## 1)AOP简介
就是OOP的升级和延续，AOP可以对各个部分进项隔离，达到松耦合的目的，提高程序的可重用性，提高开发效率；
 例如： B，C 都想需要 A的功能
- 没有Aop就需要自己写进去；
- 要是有AOP就可以通过配置的方式，进项配置就行；
优点：
在不修改代码的前提下，增加代码的功能；
### 1.1)OOP开发思路

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-8b400a85b4944b24a83bcc6fc7362b9e.png)

### 1.2)AOP开发思想

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-d85cf678cd9f4396822b8b23ae885eed.png)
...
之前：
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-407c9945b88d48f4b07bdf8b8019a543.png)
进化：
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-cccb57debb0c431e91b42fd74e34dfba.png)
最终:(AOP)
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-32fb11d57f6544349d26463921a12c3b.png)
### 1.5)AOP优势
...
- 业务功能扩展更便捷
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-59d46433cb57405987e6bc8a1bf244db.png)

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-4fecc699da6a45fdac6bd4d8f50cdbc0.png)

下面这些操作，Aop都已经封装好了，只需要简单的配置就可以；
- 基于JDK的方式实现动态代理：
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-63b78a84f9f64176a749820837720b52.png)
- 基于cglib的方式实现
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-0c73349d36cd4fd9846240923824630f.png)

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-e4cb14ff772b491885c776c193ca49ae.png)
## 2)AOP入门案例

### 2.1)AOP相关概念
连接点：（可以被增强的方法 ）
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-11f9136af3444604ba4676e33ce05903.png)
切点：（真正被增强的方法）
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-4acadc74bc15421d8e5cd205810f2992.png)
通知： 加强的东西
切面： 切点+通知
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-87a0640396b1455e979a7fac6246960b.png)

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-0419001308644333933c74a8cf018569.png)
- Joinpoint(连接点)：就是方法
...
2.创建目标接口和目标类（内有切点  和 连接点）

3.创建切面类（内有通知 增强方法）

4.将目标类和切面类的对象交给Spring

5.在Application.xml中配置织入关系
...
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-3a6b7ecca2aa4b1a82c0bc2c89b41b8f.png)
步骤三 把通知加入spring容器管理
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-04687180db0145e8bdf59589c0a1d1d4.png)
步骤四 在配置文件中配置aop的配置 
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-0bcee7b0fa8c434395451325c9dbc558.png)

pointcut： 后面可以写一个方法，当然一般使用切点表达式（让很多方法同时生效）
```xml
<!--aop配置-->
<aop:config>
    <!--配置切入点-->
...
​	关键字：描述表达式的匹配模式（参看关键字列表）两个点表示任意参数
...
**（）是参数 前的第一个是方法 在前是类 在前是包**
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-fa9b49a6d1354407b7db503e3b9e89cc.png)
- 范例：
...
```
#### 3.4.6)抽取切点表达式
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-d6f2363c20e64c3887533b0e204b2253.png)
### **3.5)切入点的三种配置方式**
...
### **3.7)通知类型**
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-e11c398ca3fc4e50ab0d93d0ce742e9c.png)
...
#### 3.7.3)aop:after-returning  （后置增强）
...
```java
  ...
  syatem.out.println（“环绕前”）    
  Object ret = pjp.proceed();//执行切点方法
 syatem.out.println（“环绕后”）    
      return ret;
  }
```
...
- 原始方法
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-c238e23757704027ba749eb9d03a63fc.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-bd772c8c51af4103af5a88ce5e015097.png)
#### **3.9.2)通知获取返回值数据**
...
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-a2c60f9356c840a6888653d0f5fd64cc.png)

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-e0cd98f0b0724e03a47d40a87b9fe37a.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-6219ce2bbf8342b58dfbf4a7e2a9b6e7.png)
...
#### 4.4.2)@Pointcut （切点表达式的方法 来抽取共同的）
...
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-6fab96eb610247758ba7c157e50152fb.png)
...
- 这个增强默认是给所有的方法进行增强包括啊 toString（） 和 hashCode（）
当你需要给指定的方法进行增强的时候，就需要判断条件；
- CGLIB动态代理不限定是否具有接口，可以对任意操作进行增强

- CGLIB动态代理无需要原始被代理对象，动态创建出新的代理对象


![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-8ac140eb36314889a84e44181eb424ba.png)
...
Spirng可以通过配置的形式控制使用的代理形式，默认使用jdk proxy，通过配置可以修改为使用cglib
...
### **6.5)织入时机**
![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-80bc8cae8e0a4bda8d461adf7848006c.png)

![image.png](https://cdn.jsdelivr.net/gh/Control-body/tuChuang/2022/04/image-20e2be4786644e2182cbebc5552c189f.png)