...
![image.png](/upload/2022/04/image-b9f352b6be5e44e697eb1276498f81b5.png)

![image.png](/upload/2022/04/image-df36a0c8ba3543c0a023361b32faf1f3.png)	
...
![image.png](/upload/2022/04/image-289ba364c274444c83b21345293b9719.png)

- **创建格式**

![image.png](/upload/2022/04/image-875bcfa30f2a46b48b27b70d752f01ef.png)

- **常用方法**

![image.png](/upload/2022/04/image-bdf43f4a596b43a0a0fdb41e7a170b7a.png)
...
![image.png](/upload/2022/04/image-f18fc0611d934078955a3e8242056f37.png)

- **ObjectMapper常用方法**

![image.png](/upload/2022/04/image-7ca4a7bd958247cf949d1fb7c442d62a.png)
...
- **常用类**
![image.png](/upload/2022/04/image-8cf41c70c34f4b7f9e2fb3a0f2f54ea2.png)

# 3、综合案例 搜索联想

- **案例效果和环境介绍**
![image.png](/upload/2022/04/image-227d162cabcd4b4db55613bc1f99f29d.png)
...
# 4、综合案例 分页
## 4.0.0 mybatis集成分页助手的流程：
1.在mybatis.xml中集成分页助手
![image.png](/upload/2022/04/image-971a646d9dcc4d89b35938e5a039752f.png)
2.在Service层实现分页接口
![image.png](/upload/2022/04/image-dd8299d4ee0943168c385795a45ace88.png)
3.实现分页接口的方法
![image.png](/upload/2022/04/image-1b8c79ecd5f74c139c4ba1cf158e6de9.png)
4.查询SQl语句
![image.png](/upload/2022/04/image-0d75a2695a8444c39e6d837753626c18.png)
​			瀑布流无限加载数据分页
...
![image.png](/upload/2022/04/image-2e1af608b05841fab8ad6191d54f106e.png)
...
![image.png](/upload/2022/04/image-ce5581fc6c39470083b52d19891047fe.png)

![image.png](/upload/2022/04/image-59dea697b4e44e6a840558c095057121.png)
## 4.3、案例的实现
...
![image.png](/upload/2022/04/image-b3b601a8f9124617ab1a638d2d560118.png)
- **案例效果和环境准备**
...
- **案例的分析**
  ...
  - **服务器**
    ...
    - 1. 获取请求参数。
      ...
      4. 将得到的数据转为 json。
      5. 将数据响应给客户端。
![image.png](/upload/2022/04/image-55c66310e9ce421c952bde3d0227f242.png)
- **案例的实现**
